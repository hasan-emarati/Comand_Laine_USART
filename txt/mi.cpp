float temp0 = 0, temp1 = 0, temp2 = 0, temp3 = 0, temp4 = 0, temp5 = 0, temp6 = 0, temp7 = 0, ; // temp ADC
unsigned char A0[20], A1[20], A2[20], A3[20], A4[20], A5[20], A6[20], A7[20]; // Arayeh baray ADC
char lcd[256];
char getch;
char data;
